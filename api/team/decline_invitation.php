...
if ($auth->isLoggedIn()) {
    ...
    // create the team
    if($team->decline_invitation($team->id, $team->authid)){
        ...
        // tell the user
        echo json_encode(array("message" => "Invitation declined."));
    }
    ...
    // if unable to create the team, tell the user
        ...
        // tell the user
        echo json_encode(array("message" => "Unable to decline invitation."));
    }
