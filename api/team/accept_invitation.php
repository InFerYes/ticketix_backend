...
if ($auth->isLoggedIn()) {
    ...
    // create the team
    if($team->accept_invitation($team->id, $team->authid)){
        ...
        // tell the user
        echo json_encode(array("message" => "Invitation accepted."));
    }
    ...
    // if unable to create the team, tell the user
        ...
        // tell the user
        echo json_encode(array("message" => "Unable to accept invitation."));
    }
